...
private val TAG = SQLiteModuleUpdated::class.java.simpleName
private val EMPTY_ROWS = arrayOf<Array<Any?>>()
private val EMPTY_COLUMNS = arrayOf<String?>()
private val EMPTY_RESULT = SQLiteModuleUpdated.SQLitePluginResult(EMPTY_ROWS, EMPTY_COLUMNS, 0, 0, null)
private val DATABASES: MutableMap<String, SQLiteDatabase?> = HashMap()

class SQLiteModuleUpdated(private val mContext: Context) : ExportedModule(mContext) {
  override fun getName(): String {
    return "ExponentSQLiteUpdated"
  }
